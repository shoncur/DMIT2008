...
export default function Home() {
  ...
  useEffect(() => {
    ...
    loadAllReviews()
  }, []) // dependency array of [] means on mount
  ...
  dependency array [reviews] only listens to changes to the *reviews* stateful variable
  this is triggered when *setReviews* is called
  */

  const deleteReviewFromState = (deleteReviewId) => {
