...
(0, _astronaut.getAstronautList)().then((astronautData)=>{
    let astroListElement = document.querySelector(".astronaut-list");
    console.log("Successful fetch");
    console.log(astronautData);
    astronautData.results.map((data)=>{
        (0, _astronaut1.renderAstronautListItem)(data, astroListElement);
    });
});

},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","./dom/astronaut":"a988T","./api/astronaut":"j9BdQ"}],"i5LP7":[function() {},{}],"a988T":[function(require,module,exports) {
...
},{}],"j9BdQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
